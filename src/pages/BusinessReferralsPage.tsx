...
export function BusinessReferralsPage() {
  const {
    ...
    setDateTo,
    refetchBusiness,
    page, setPage, totalPagesBusiness
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">
            {totalBusiness} resultados encontrados
          </p>
        </div>
        <button
      ...
      {!loading && !error && <CorporateReferralTable data={dataBusiness} onUpdated={refetchBusiness}
      page={page}
      totalPages={totalPagesBusiness}
      setPage={setPage} />}
